...
videos.each_with_index do |video, index|
  ...
  source.video.attach(io: 'https://res.cloudinary.com/dcug1pvpk/video/upload/v1716529190/lazyreel-seeds/story-video-1.mp4', filename: "#{video}.mp4", content_type: 'video/mp4')
